...
public class FriendsEventsRecyclerAdapter
	...
	protected void populateViewHolder(final FriendEventViewHolder viewHolder, FriendEventItem model, int position) {
		...
		viewHolder.friendsEventDetailsImageButton.setOnClickListener(new View.OnClickListener() {
	...
	public static class FriendEventViewHolder
		...
		ImageButton friendsEventDetailsImageButton;
		...
		public FriendEventViewHolder(View itemView) {
			...
			friendsEventDetailsImageButton = itemView.findViewById(R.id.friends_events_details_imageButton);
		}
	}
}
