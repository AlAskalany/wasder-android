...
public class RecommendedEventItem
	...
	public RecommendedEventItem() {
		
	}
	
	public RecommendedEventItem(String uId, String id, String title, String subhead, String photoUrl, String imageUrl, String supplementaryText) {
