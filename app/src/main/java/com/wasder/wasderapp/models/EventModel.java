...
public class EventModel implements WasderDataModel {
	...
	public EventModel(String uId, String id, String title, String subhead, String photoUrl, String imageUrl, String supplementaryText) {
