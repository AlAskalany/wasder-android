...
public class EsportsModel implements WasderDataModel {
	...
	public EsportsModel(String uId, String id, String title, String subhead, String photoUrl, String imageUrl, String supplementaryText) {
