...
public class FriendEventItem
	...
	public FriendEventItem() {
		
	}
	
	public FriendEventItem(String uId, String id, String title, String subhead, String photoUrl, String imageUrl, String supplementaryText) {
